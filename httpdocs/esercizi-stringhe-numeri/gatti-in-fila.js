...
var nLines = Math.ceil(cats/catsInLine);
var catOutOfLines = cats % catsInLine;
var catLastLine = catsInLine - catOutOfLines;

console.log('numero di file: ' + nLines);
console.log('numero gatti mancanti: ' + catLastLine);